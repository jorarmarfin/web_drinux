<div class="mfn-main-slider" id="mfn-rev-slider">
    <div id="rev_slider_34_2_wrapper" class="rev_slider_wrapper fullwidthbanner-container flv_rev_14">
        <div id="rev_slider_34_2" class="rev_slider fullwidthabanner flv_rev_13">
            <ul>
                <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-thumb="{{ $slider[0]->thumbnails }}" data-saveperformance="off">
                    <img src="{{ $slider[0]->imagen }}" alt="slide-home-bg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    ...
                    <div class="tp-caption mfnrs_home sft tp-resizeme flv_rev_2" data-x="center" data-hoffset="500" data-y="center" data-voffset="-79" data-speed="500" data-start="1000" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300">
                        <span class='themecolor'> </span>{{ $slider[0]->titulo }}
                        <br>
                        <span class='themecolor'></i></span> para su empresa
                    </div>
                    <div class="tp-caption mfnrs_home_small sfl tp-resizeme flv_rev_1" data-x="center" data-hoffset="500" data-y="center" data-voffset="43" data-speed="500" data-start="2000" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300">
                        {!! $slider[0]->body !!}
                    </div>
                    <div class="tp-caption mfnrs_home_small sfr tp-resizeme flv_rev_11" data-x="center" data-hoffset="500" data-y="center" data-voffset="132" data-speed="500" data-start="1600" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300">
                        <div class="hr_zigzag">
                            <i class="icon-down-open"></i><i class="icon-down-open"></i><i class="icon-down-open"></i>
                        </div>
                    </div>
                    <div class="tp-caption mfnrs_home_tiny sfb tp-resizeme flv_rev_10" data-x="center" data-hoffset="500" data-y="center" data-voffset="196" data-speed="500" data-start="2900" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300">
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-thumb="{{ $slider[1]->imagen }}" data-saveperformance="off">
                    ...
                    <div class="tp-caption large_dark sft tp-resizeme flv_rev_4" data-x="center" data-hoffset="-376" data-y="center" data-voffset="-77" data-speed="500" data-start="3500" data-easing="Power3.easeInOut" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300">
                        <span class='themecolor'>Webs</span> Para su empresa
                        <br> A su medida
                    </div>
